...
def test_run_merged_intervals_force_recreate_snapshot(mocker: MockerFixture, make_snapshot):
    ...
    mock_snapshot_evaluator.get_snapshots_to_create.assert_called_once_with(
        [snapshot],
        deployability_index,
        snapshots_to_recreate={snapshot.snapshot_id},
    )
    mock_snapshot_evaluator.create_snapshot.assert_called_once()
